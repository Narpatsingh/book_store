...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Authors</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <form method="POST" action="{{route('authors.update', ['author_id' => $author->id])}}">
            @csrf
            @method('PUT')
            ...
            <div class="card-body">
                ...
                <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input 
                            ...
                            name="first_name" 
                            value="{{ old('first_name') ?  old('first_name') : $author->first_name}}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input 
                            ...
                            name="middle_name" 
                            value="{{ old('middle_name') ?  old('middle_name') : $author->middle_name}}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input 
                            ...
                            name="last_name" 
                            value="{{ old('last_name') ?  old('last_name') : $author->last_name}}">
