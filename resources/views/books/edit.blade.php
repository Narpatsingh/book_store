...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <form method="POST" action="{{route('books.update', ['book_id' => $book->id])}}">
            @csrf
            @method('PUT')
                ...
                <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input 
                            ...
                            name="total_pages" 
                            value="{{ old('total_pages') ?  old('total_pages') : $book->total_pages}}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        {{ Form::select('author_id', $authors,$book->author_id, ['id'=>'author_id','class' => 'form-control form-control-user','placeholder' => 'Select Author','required', 'data-control'=>'select2']) }}
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input 
                            ...
                            name="image_url" 
                            value="{{ old('image_url') ?  old('image_url') : $book->image_url}}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input 
                            ...
                            name="published_date" 
                            value="{{ old('published_date') ?  old('published_date') : $book->published_date}}">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <textarea 
                            ...
                            name="description" 
                            value="{{ old('description') ?  old('description') : $book->description}}">{{ old('description') ?  old('description') : $book->description}}</textarea>
